...
import { GroupUpdateType } from '@schemas/group.schema';
...
export interface GroupPreSave extends GroupBase {
  id?: never;
}

// Interface for person after saving (id is required)
export interface GroupPostSave extends GroupBase {
  id: string;
}
...
export class GroupModel {
  ...
  constructor(data: GroupUpdateType) {
    this.id = data.id;
    this.name = data.name;
